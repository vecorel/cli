# todo remove this file once all Converters have been migrated to classes
# This approach is deprecated / not recommended any more
# based on the convert() function instead of BaseConverter()
