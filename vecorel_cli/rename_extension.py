...
def rename_extension(folder, title, slug, gh_org="vecorel", prefix=None):
    if prefix is None:
        prefix = "template"
    ...
    GH_SEARCH = ["/extension-template/", "vecorel.github.io"]
    ...
    replace_in_file(CHANGELOG, "/vecorel/extension-template/", f"/{gh_org}/{slug}/")
